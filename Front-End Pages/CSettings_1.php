...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateSql = "UPDATE $table SET CFirstName='$FirstName', CLastName='$LastName', PhoneNumber='$PhoneNumber', EducationLevel='$EducationLevel', Password='$Password' WHERE EmailAddress='$username' or Password='$password'";
...
<body>
    ...
    <div class="middle-panel" style="margin: 50px auto; padding: 20px; width: 50%; background-color: rgba(255, 255, 255, 0.5); border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.2); text-align: center;">
        <form action="CSettings.php" method="POST">
            ...
            <br>
            <input type="text" id="EducationLevel" name="EducationLevel" required style="font-size: 20px; padding: 10px; width: 80%; margin: 10px auto;">
            <br>
